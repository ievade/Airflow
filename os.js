...
function spwn(t, c) {
  ...
  maxButton.classList.add("px-2", "rounded-sm", "bg-blue-700", "hover:bg-blue-600", "float-right", "h-full", "hover:text-white", "maxbtn");
  maxButton.style.lineHeight = "16px";
  ...
  actionBarElem.appendChild(maxButton);
  ...
  windowElem.addEventListener("click", function(e) {
    if (e.target.classList.contains("maxbtn")) {
      console.log("max button clicked 4");
      windowElem.style.width = "99%";
      windowElem.style.height = "91.5%";
      windowElem.style.top = "2rem";
